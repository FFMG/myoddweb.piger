 ...
 * @return void
 */
bool PowershellApi::Say(const wchar_t* msg, UINT nElapse, UINT nFadeOut)
{
  // display the message
 ...
 * @return void
 */
bool PowershellApi::Execute(const wchar_t* module, const wchar_t* cmdLine, bool isPrivileged )
{
