 ...
 */
void ActiveActionsRunner::QueueAndExecute(IActiveAction* activeAction )
{
  //  it could be NULL.
 ...
 */
void ActiveActionsRunner::RemoveRunner(IActiveAction* runner )
{
  //  lock it.
  myodd::threads::Lock guard(_mutexRunner);
 ...
 */
void ActiveActionsRunner::Execute(IActiveAction* runner, ActiveActionsRunner* parent )
{
  //  do the action.
