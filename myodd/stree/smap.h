...
namespace sti
{
    namespace implementation
    {
        ...
        public:
            ...
            const_iterator lower_bound( const key_type& key )const       { return const_iterator(super_t::lower_bound(key)); }
            const_iterator upper_bound( const key_type& key )const       { return const_iterator(super_t::upper_bound(key)); }
